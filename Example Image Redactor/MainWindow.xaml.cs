...
//Пространства имен которые необходимо добавить
using Emgu.CV.Structure;
using Emgu.CV;

namespace Example_Image_Redactor
{
    /// <summary>
    ...
    {
        //Главный объект для работы с изображением в Emgu.CV. Этот обьект должен быть обьявлен глобально в проекте.
        ...
        {
            /// Здесь требуется добавить логику использования класса OpenFileDialog

            //Cоздаем объект Image<Bgr, byte> напрямую из пути к файлу, Emgu.CV сам его загрузит и декодирует.
            sourceImage = new Image<Bgr, byte>("image.jpg");
        ...
        {
            /// Здесь требуется добавить логику использования класса SaveFileDialog

            //У Emgu.CV есть удобный встроенный метод .Save()
            sourceImage.Save("image_saved.jpg");
        }
